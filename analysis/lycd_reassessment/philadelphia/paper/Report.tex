...
more than a tenth --- but \LycdAVacantShareOfShift{} of the increases land on vacant lots, where the method's
...
Painted onto every parcel --- the rate imported and this notebook's own lot area applied, except
that a condominium unit takes its livable-area share of its building's lot, and a lot whose
recorded area is more than twice both surveyed polygons takes the polygon's --- the
...
the improved-parcel cap binds: before it, the surface's land \emph{alone} exceeds OPA's
...
boosted trees tell the same story less steeply (Figure~\ref{fig:eqprofile}), and across
...
is \LycdEqSfiveExpiredMinWin{}, and the groups where most homes pay more are
\LycdEqSfiveExpiredLosingGroups{}.
...
(\LycdSzeroPrb{}). But the boosted trees sit inside it (\LycdEgbmPrb{}) and are still clearly
progressive (\LycdEqEgbmEndsHomesPoor{} poorest, \LycdEqEgbmEndsHomesRich{} richest,
