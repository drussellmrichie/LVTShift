...
Painted onto every parcel --- the rate imported, this notebook's own lot area applied --- the
...
aggregate. \LycdSfivePreCapExceedsCondo{} of those are the known lot-area artifact (a
condominium unit inheriting a whole lot's area); the remaining \LycdSfivePreCapExceedsCore{}
(\LycdSfivePreCapExceedsCorePct{} of improved parcels with a lot of their own,
\LycdSfiveCapRemovedCoreB{}) are parcels whose land, at what nearby land sells for, is worth
...
\item \textbf{\LycdSfiveKnnValuePct{} of market value is painted by nearest neighbour, and
  ...
  the AVM universe's coverage; the second is the lot-area artifact on condominium units plus
  \LycdSfivePreCapExceedsCore{} parcels whose totals the sales say are too low. Both are
